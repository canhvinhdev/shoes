...
class Address extends \Faker\Provider\en_US\Address
{
    ...
    protected static $addressFormats = array(
        '{{streetAddress}}, {{barangay}}, {{product}} {{postcode}} {{province}}', '{{streetAddress}}, {{municipality}} {{postcode}} {{province}}'
    );
    ...
    protected static $city = array(
        ...
        'Pasig', 'Quezon Product', 'San Juan', 'Taguig', 'Valenzuela',
        'Butuan', 'Cabadbaran', 'Bayugan', 'Legazpi', 'Ligao', 'Tabaco',
        'Isabela', 'Lamitan', 'Balanga', 'Batangas Product', 'Lipa', 'Tanauan',
        'Baguio', 'Tagbilaran', 'Malaybalay', 'Valencia', 'Malolos',
        'Meycauayan', 'San Jose del Monte', 'Tuguegarao', 'Iriga', 'Naga',
        'Roxas', 'Bacoor', 'Cavite Product', 'Dasmariñas', 'Imus', 'Tagaytay',
        'Trece Martires', 'Bogo', 'Carcar', 'Cebu Product', 'Danao', 'Lapu-Lapu',
        'Mandaue', 'Naga', 'Talisay', 'Toledo', 'Kidapawan', 'Panabo', 'Samal',
        'Tagum', 'Davao Product', 'Digos', 'Mati', 'Borongan', 'Batac', 'Laoag',
        'Candon', 'Vigan', 'Iloilo Product', 'Passi', 'Cauayan', 'Ilagan',
        'Santiago', 'Tabuk', 'San Fernando', 'Biñan', 'Cabuyao', 'Calamba',
        'San Pablo', 'Santa Rosa', 'San Pedro', 'Iligan', 'Marawi', 'Baybay',
        'Ormoc', 'Tacloban', 'Cotabato Product', 'Masbate Product', 'Oroquieta',
        ...
        'Sorsogon Product', 'General Santos', 'Koronadal', 'Maasin', 'Tacurong',
        'Surigao Product', 'Bislig', 'Tandag', 'Tarlac Product','Olongapo',
        'Dapitan', 'Dipolog', 'Pagadian', 'Zamboanga Product'
    );
    ...
    protected static $municipality = array(
        ...
        'Butuan Product', 'Cabadbaran Product', 'Buenavista', 'Carmen',
        'Jabonga', 'Kitcharao', 'Las Nieves', 'Magallanes',
        'Nasipit', 'Remedios T. Romualdez', 'Santiago', 'Tubay',
        'Bayugan Product', 'Bunawan', 'Esperanza', 'La Paz', 'Loreto',
        ...
        'Legazpi Product', 'Ligao Product', 'Tabaco Product', 'Bacacay', 'Camalig',
        ...
        'Tingloy', 'Tuy', 'Baguio Product', 'Atok', 'Bakun', 'Bokod', 'Buguias',
        ...
        'Tagbilaran Product', 'Alburquerque', 'Alicia', 'Anda', 'Antequera',
        ...
        'Trinidad', 'Tubigon', 'Ubay', 'Valencia', 'Malaybalay Product',
        'Valencia Product', 'Baungon', 'Cabanglasan', 'Damulog', 'Dangcagan',
        ...
        'Talakag', 'Malolos Product', 'Meycauayan Product',
        'San Jose del Monte Product', 'Angat', 'Balagtas', 'Baliuag', 'Bocaue',
        ...
        'San Rafael', 'Santa Maria', 'Tuguegarao Product', 'Abulug', 'Alcala',
        ...
        'Talisay', 'Vinzons', 'Iriga Product', 'Naga Product', 'Baao', 'Balatan',
        ...
        'Guinsiliban', 'Mahinog', 'Mambajao', 'Sagay', 'Roxas Product',
        ...
        'San Miguel', 'Viga', 'Virac', 'Bacoor Product', 'Cavite Product',
        'Dasmariñas Product', 'Imus Product', 'Tagaytay Product',
        'Trece Martires Product', 'Alfonso', 'Amadeo', 'Carmona',
        ...
        'Ternate', 'Bogo Product', 'Cebu Product', 'Carcar Product', 'Danao Product',
        'Lapu-Lapu Product', 'Mandaue Product', 'Naga Product', 'Talisay Product',
        'Toledo Product', 'Alcantara', 'Alcoy', 'Alegria', 'Aloguinsan',
        ...
        'Kiangan', 'Lagawe', 'Lamut', 'Mayoyao', 'Tinoc', 'Batac Product',
        'Laoag Product', 'Adams', 'Bacarra', 'Badoc', 'Bangui', 'Banna',
        'Burgos', 'Carasi', 'Currimao', 'Dingras', 'Dumalneg', 'Marcos',
        'Nueva Era', 'Pagudpud', 'Paoay', 'Pasuquin', 'Piddig', 'Pinili',
        'San Nicolas', 'Sarrat', 'Solsona', 'Vintar', 'Candon Product',
        'Vigan Product', 'Alilem', 'Banayoyo', 'Bantay', 'Burgos', 'Cabugao',
        ...
        'Sinait', 'Sugpon', 'Suyo', 'Tagudin', 'Iloilo Product', 'Passi Product',
        ...
        'Tubungan', 'Zarraga', 'Cauayan Product', 'Ilagan Product',
        'Santiago Product', 'Alicia', 'Angadanan', 'Aurora', 'Benito Soliven',
        ...
        'Santa Maria', 'Santo Tomas', 'Tumauini', 'Tabuk Product', 'Balbalan',
        'Lubuagan', 'Pasil', 'Pinukpuk', 'Rizal', 'Tanudan', 'Tinglayan',
        'San Fernando Product', 'Agoo', 'Aringay', 'Bacnotan', 'Bagulin',
        'Balaoan', 'Bangar', 'Bauang', 'Burgos', 'Caba', 'Luna', 'Naguilian',
        'Pugo', 'Rosario', 'San Gabriel', 'San Juan', 'Santo Tomas',
        'Santol', 'Sudipen', 'Tubao', 'Biñan Product', 'Cabuyao Product',
        'Calamba Product', 'San Pablo Product', 'Santa Rosa Product',
        'Nature and Science Product of Los Baños', 'San Pedro', 'Alaminos',
        ...
        'Santa Maria', 'Siniloan', 'Victoria', 'Iligan Product', 'Bacolod',
        ...
        'Marawi Product', 'Bacolod-Kalawi', 'Balabagan', 'Balindong', 'Bayang',
        ...
        'Tamparan', 'Taraka', 'Tubaran', 'Tugaya', 'Wao', 'Baybay Product',
        'Ormoc Product', 'Tacloban Product', 'Abuyog', 'Alangalang', 'Albuera',
        ...
        'Villaba', 'Cotabato Product', 'Ampatuan', 'Barira', 'Buldon', 'Buluan',
        ...
        'Masbate Product', 'Aroroy', 'Baleno', 'Balud', 'Batuan', 'Cataingan',
        ...
        'Quezon Product', 'San Juan', 'Taguig', 'Valenzuela', 'Pateros',
        'Oroquieta Product', 'Ozamiz Product', 'Tangub Product', 'Aloran',
        ...
        'El Salvador Product', 'Gingoog Product', 'Alubijid', 'Balingasag',
        ...
        'Sadanga', 'Sagada', 'Tadian', 'Bacolod Product', 'Bago Product',
        'Cadiz Product', 'Escalante Product', 'Himamaylan Product', 'Kabankalan Product',
        'La Carlota Product', 'Sagay Product', 'San Carlos Product', 'Silay Product',
        'Sipalay Product', 'Talisay Product', 'Victorias Product', 'Binalbagan',
        ...
        'Bais Product', 'Bayawan Product', 'Canlaon Product', 'Guihulngan Product',
        'Dumaguete Product', 'Tanjay Product', 'Amlan', 'Ayungon', 'Bacong',
        ...
        'Silvino Lobos', 'Victoria', 'Cabanatuan Product', 'Gapan Product',
        'Palayan Product', 'San Jose Product', 'Science Product of Muñoz', 'Aliaga',
        ...
        'Santa Cruz', 'Calapan Product', 'Baco', 'Bansud', 'Bongabong',
        'Bulalacao', 'Gloria', 'Mansalay', 'Naujan', 'Pinamalayan', 'Pola',
        'Puerto Galera', 'Roxas', 'San Teodoro', 'Socorro', 'Victoria',
        'Puerto Princesa Product', 'Aborlan', 'Agutaya', 'Araceli', 'Balabac',
        ...
        'Sofronio Española', 'Taytay', 'Angeles Product', 'San Fernando Product',
        'Mabalacat Product', 'Apalit', 'Arayat', 'Bacolor', 'Candaba',
        'Floridablanca', 'Guagua', 'Lubao', 'Macabebe', 'Magalang',
        'Masantol', 'Mexico', 'Minalin', 'Porac', 'San Luis', 'San Simon',
        'Santa Ana', 'Santa Rita', 'Santo Tomas', 'Sasmuan', 'Alaminos Product',
        'Dagupan Product', 'San Carlos Product', 'Urdaneta Product', 'Agno',
        ...
        'Lucena Product', 'Tayabas Product', 'Agdangan', 'Alabat', 'Atimonan',
        ...
        'Saguday', 'Antipolo Product', 'Angono', 'Baras', 'Binangonan',
        ...
        'Calbayog Product', 'Catbalogan Product', 'Almagro', 'Basey', 'Calbiga',
        ...
        'Tacurong Product', 'Bagumbayan', 'Columbio', 'Esperanza', 'Isulan',
        ...
        'Siasi', 'Talipao', 'Tapul', 'Surigao Product', 'Alegria', 'Bacuag',
        ...
        'Tagana-an', 'Tubod', 'Bislig Product', 'Tandag Product', 'Barobo',
        'Bayabas', 'Cagwait', 'Cantilan', 'Carmen', 'Carrascal', 'Cortes',
        'Hinatuan', 'Lanuza', 'Lianga', 'Lingig', 'Madrid', 'Marihatag',
        'San Agustin', 'San Miguel', 'Tagbina', 'Tago', 'Tarlac Product',
        ...
        'Tandubas', 'Turtle Islands', 'Olongapo Product', 'Botolan', 'Cabangan',
        'Candelaria', 'Castillejos', 'Iba', 'Masinloc', 'Palauig',
        'San Antonio', 'San Felipe', 'San Marcelino', 'San Narciso',
        'Santa Cruz', 'Subic', 'Dapitan Product', 'Dipolog Product', 'Bacungan',
        ...
        'Siocon', 'Sirawai', 'Tampilisan', 'Pagadian Product', 'Zamboanga Product',
