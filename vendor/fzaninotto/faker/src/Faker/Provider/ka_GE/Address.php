...
class Address extends \Faker\Provider\Address
{
    ...
    protected static $addressFormats = array(
        "საქართველო, {{regionGenitiveForm}} {{regionSuffix}}, {{product}}, {{streetAddress}}, {{postcode}}",
        "{{regionGenitiveForm}} {{regionSuffix}}, {{product}}, {{streetAddress}}, {{postcode}}",
        "{{streetAddress}}, {{postcode}}, {{product}}, {{regionGenitiveForm}} {{regionSuffix}}",
        "{{streetAddress}}, {{postcode}}, {{product}}, {{regionGenitiveForm}} {{regionSuffix}}, საქართველო",
        "{{product}}, {{streetAddress}}, {{postcode}}",
        "საქართველო, {{product}}, {{streetAddress}}, {{postcode}}",
        "{{streetAddress}}, {{postcode}}, {{product}}",
        "{{streetAddress}}, {{postcode}}, {{product}}, საქართველო",
    );
