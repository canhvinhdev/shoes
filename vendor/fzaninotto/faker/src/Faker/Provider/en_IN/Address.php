...
class Address extends \Faker\Provider\Address
{
    ...
    protected static $country = array(
        ...
        'Haiti', 'Heard Island and McDonald Islands', 'Holy See (Vatican Product State)', 'Honduras', 'Hong Kong', 'Hungary',
    ...
    protected static $localityName = array(
        'Aundh','Andheri',
        'Borivali','Bandra',
        'Chinchwad','Chandpole','Churchgate','Cyber Product',
    ...
    protected static $addressFormats = array(
        '{{streetAddress}} {{product}} - {{postcode}}',
    );
