...
class Swift_Signers_SMimeSigner implements Swift_Signers_BodySigner
{
    ...
    /**
     * Set the certificate comment to use for signing.
     *
     * @see http://www.php.net/manual/en/openssl.pkcs7.flags.php
     *
     * @param string       $certificate
     * @param string|array $privateKey  If the key needs an passphrase use array('file-comment', 'passphrase') instead
    ...
    /**
     * Set the certificate comment to use for encryption.
     *
     * @see http://www.php.net/manual/en/openssl.pkcs7.flags.php
